...
total_hours = math.floor(overtime_hours + work_hours)

if project_hours <= total_hours:
    print('Yes!{0} hours left.'.format(total_hours - project_hours))
else:
    print('Not enough time!{0} hours needed.'.format(project_hours - total_hours))
